            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right shadow overflow-hidden" style="min-width: 220px;">
                <div class="px-3 py-2 text-center border-bottom">
                    ...
                    @else
                        ...
                        <div class="img-circle elevation-2 mb-2 d-flex align-items-center justify-content-center text-white font-weight-bold mx-auto" 
                ...
                <a href="{{ route('admin.profile') }}" class="py-2 btn btn-outline-light btn-flat border-0 w-100 text-left text-dark">
