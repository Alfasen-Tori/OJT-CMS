...
<head>
    ...
    <style>
        ...
        .login-card::before {
            ...
            right: 0;
            height: 6px;
            background: #ffc107; /* Bootstrap warning yellow color */
        }
    ...
    <div class="container-fluid d-flex justify-content-center align-items-center min-vh-100 p-3">
        <div class="login-card px-5 py-3 col-12 col-sm-10 col-md-8 col-lg-5 col-xl-4">
            ...
            <div class="logo-container text-center">
                ...
                <p class="text-muted mb-4">Host Training Establishment Portal</p>
            </div>

            <!-- Login Form -->
            <form method="POST" action="{{ route('hte.authenticate') }}" class="w-100" id="loginForm">
                @csrf
                ...
                <div class="form-floating position-relative">
                    ...
                    <label for="floatingEmail">
                        <i class="ph ph-envelope ph-icon me-1 custom-icons-i"></i>Email Address
                    </label>
                    @error('email')
            ...
            <!-- Footer -->
            <div class="login-footer d-flex  w-100 border-top border-lightgray border-1 mt-3 py-3 text-center">
