...
<head>
    ...
    <title>Coordinator Login - OJT-CMS</title>
    ...
    <style>
        ...
        .login-card::before {
            ...
            right: 0;
            height: 6px;
            background: #198754; /* Coordinator green color */
        }
        ...
        .portal-title {
            color: #198754; /* Coordinator green color */
            font-weight: 700;
    ...
    <div class="container-fluid d-flex justify-content-center align-items-center min-vh-100 p-3">
        <div class="login-card p-5 col-12 col-sm-10 col-md-8 col-lg-5 col-xl-4">
            ...
            <div class="logo-container text-center">
                ...
                <p class="text-muted mb-4">Coordinator Portal</p>
            </div>

            <!-- Login Form -->
            <form method="POST" action="{{ route('coordinator.authenticate') }}" class="w-100" id="loginForm">
                @csrf
