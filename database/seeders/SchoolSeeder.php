...
class SchoolSeeder extends Seeder
{
    public function run()
    {
        ...
        $departments = [
            ...
            ['dept_name' => 'Bachelor of Science in Architecture', 'short_name' => 'BSARCH', 'college_id' => $ids['College of Architecture and Allied Discipline']],
            ['dept_name' => 'Bachelor of Science in Interior Design', 'short_name' => 'BSID', 'college_id' => $ids['College of Architecture and Allied Discipline']],

            // College of Arts & Sciences
            ['dept_name' => 'Bachelor of Arts in English Language', 'short_name' => 'BAEL', 'college_id' => $ids['College of Arts & Sciences']],
            ['dept_name' => 'Bachelor of Science in Economics', 'short_name' => 'BSECON', 'college_id' => $ids['College of Arts & Sciences']],
            ['dept_name' => 'Bachelor of Science in Environmental Science', 'short_name' => 'BSES', 'college_id' => $ids['College of Arts & Sciences']],
            ['dept_name' => 'Bachelor of Science in Chemistry', 'short_name' => 'BSCHEM', 'college_id' => $ids['College of Arts & Sciences']],
            ['dept_name' => 'Bachelor of Science in Mathematics', 'short_name' => 'BSMATH', 'college_id' => $ids['College of Arts & Sciences']],
            ['dept_name' => 'Bachelor of Science in Statistics', 'short_name' => 'BSSTAT', 'college_id' => $ids['College of Arts & Sciences']],
            ['dept_name' => 'Batsilyer ng Sining sa Filipino', 'short_name' => 'BSFIL', 'college_id' => $ids['College of Arts & Sciences']],

            // College of Business & Entrepreneurship
            ['dept_name' => 'Bachelor of Science in Accountancy', 'short_name' => 'BSA', 'college_id' => $ids['College of Business & Entrepreneurship']],
            ['dept_name' => 'Bachelor of Science in Business Administration major in Marketing', 'short_name' => 'BSBA-MKT', 'college_id' => $ids['College of Business & Entrepreneurship']],
            ['dept_name' => 'Bachelor of Science in Entrepreneurship', 'short_name' => 'BSENTREP', 'college_id' => $ids['College of Business & Entrepreneurship']],
            ['dept_name' => 'Bachelor of Science in Office Administration', 'short_name' => 'BSOA', 'college_id' => $ids['College of Business & Entrepreneurship']],

            // College of Education
            ['dept_name' => 'Bachelor of Culture & Arts Education', 'short_name' => 'BCAED', 'college_id' => $ids['College of Education']],
            ['dept_name' => 'Bachelor of Elementary Education', 'short_name' => 'BEED', 'college_id' => $ids['College of Education']],
            ['dept_name' => 'Bachelor of Secondary Education major in Mathematics', 'short_name' => 'BSED-MATH', 'college_id' => $ids['College of Education']],
            ['dept_name' => 'Bachelor of Secondary Education major in Science', 'short_name' => 'BSED-SCI', 'college_id' => $ids['College of Education']],
            ...
            ['dept_name' => 'Bachelor of Science in Civil Engineering', 'short_name' => 'BSCE', 'college_id' => $ids['College of Engineering']],
            ['dept_name' => 'Bachelor of Science in Chemical Engineering', 'short_name' => 'BSCHE', 'college_id' => $ids['College of Engineering']],
            ['dept_name' => 'Bachelor of Science in Electronics Engineering', 'short_name' => 'BSECE', 'college_id' => $ids['College of Engineering']],
            ['dept_name' => 'Bachelor of Science in Electrical Engineering', 'short_name' => 'BSEE', 'college_id' => $ids['College of Engineering']],
            ['dept_name' => 'Bachelor of Science in Geodetic Engineering', 'short_name' => 'BSGE', 'college_id' => $ids['College of Engineering']],
            ['dept_name' => 'Bachelor of Science in Industrial Engineering', 'short_name' => 'BSIE', 'college_id' => $ids['College of Engineering']],
            ['dept_name' => 'Bachelor of Science in Information Technology', 'short_name' => 'BSIT', 'college_id' => $ids['College of Engineering']],
            ['dept_name' => 'Bachelor of Science in Mechanical Engineering', 'short_name' => 'BSME', 'college_id' => $ids['College of Engineering']],
